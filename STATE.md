...
- The linked Virtuals agent profile page shows no jobs, offers, resources, or subscriptions. This is an agent-profile configuration view, not proof that the CLI-created job was cancelled. The ACP history endpoint remains the authoritative read for job `75773`, and the mismatch is recorded as a provider/UI visibility blocker.
